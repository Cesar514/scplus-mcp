...
// Purpose: Run one git command inside the temporary exact-tools fixture repository.
...
// Purpose: Create the source files used by the exact-tools integration fixture repository.
