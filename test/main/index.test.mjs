...
describe("index", () => {
  it("creates the .contextplus project layout and snapshots", async () => {
    ...
    try {
      ...
      assert.equal(config.artifactVersion, 9);
      assert.equal(config.indexMode, "full");
      assert.equal(config.contract.contractVersion, 7);
      ...
      assert.equal(indexStatus.contractVersion, 7);
      assert.equal(indexStatus.artifactVersion, 9);
      ...
      assert.equal(stageState.contractVersion, 7);
      ...
      assert.equal(chunkIndex.artifactVersion, 9);
      assert.equal(chunkIndex.contractVersion, 7);
      ...
      assert.equal(hybridChunkIndex.artifactVersion, 9);
      assert.equal(hybridChunkIndex.contractVersion, 7);
      ...
      assert.equal(hybridIdentifierIndex.artifactVersion, 9);
      assert.equal(hybridIdentifierIndex.contractVersion, 7);
      ...
      assert.equal(structureIndex.artifactVersion, 9);
      assert.equal(structureIndex.contractVersion, 7);
      ...
      assert.equal(semanticClusterIndex.artifactVersion, 9);
      assert.equal(semanticClusterIndex.contractVersion, 7);
      ...
      assert.equal(fullManifest.artifactVersion, 9);
      assert.equal(fullManifest.contractVersion, 7);
