...
describe("index", () => {
  it("creates the populated .contextplus project layout and snapshots", async () => {
    ...
    try {
      ...
      assert.equal(config.artifactVersion, 14);
      assert.equal(config.generation, 1);
      assert.equal(config.indexMode, "full");
      assert.equal(config.contract.contractVersion, 12);
      ...
      assert.equal(manifest.contractVersion, 12);
      ...
      assert.equal(indexStatus.contractVersion, 12);
      assert.equal(indexStatus.artifactVersion, 14);
      ...
      assert.equal(stageState.contractVersion, 12);
      ...
      assert.equal(chunkIndex.artifactVersion, 14);
      assert.equal(chunkIndex.contractVersion, 12);
      ...
      assert.equal(hybridChunkIndex.artifactVersion, 14);
      assert.equal(hybridChunkIndex.contractVersion, 12);
      ...
      assert.equal(hybridIdentifierIndex.artifactVersion, 14);
      assert.equal(hybridIdentifierIndex.contractVersion, 12);
      ...
      assert.equal(structureIndex.artifactVersion, 14);
      assert.equal(structureIndex.contractVersion, 12);
      ...
      assert.equal(semanticClusterIndex.artifactVersion, 14);
      assert.equal(semanticClusterIndex.contractVersion, 12);
      ...
      assert.equal(hubSuggestionIndex.artifactVersion, 14);
      assert.equal(hubSuggestionIndex.contractVersion, 12);
      ...
      assert.equal(fullManifest.artifactVersion, 14);
      assert.equal(fullManifest.contractVersion, 12);
