...
describe("index", () => {
  it("creates the .contextplus project layout and snapshots", async () => {
    ...
    try {
      ...
      assert.equal(config.artifactVersion, 10);
      assert.equal(config.indexMode, "full");
      assert.equal(config.contract.contractVersion, 8);
      ...
      assert.equal(indexStatus.contractVersion, 8);
      assert.equal(indexStatus.artifactVersion, 10);
      ...
      assert.equal(stageState.contractVersion, 8);
      ...
      assert.equal(chunkIndex.artifactVersion, 10);
      assert.equal(chunkIndex.contractVersion, 8);
      ...
      assert.equal(hybridChunkIndex.artifactVersion, 10);
      assert.equal(hybridChunkIndex.contractVersion, 8);
      ...
      assert.equal(hybridIdentifierIndex.artifactVersion, 10);
      assert.equal(hybridIdentifierIndex.contractVersion, 8);
      ...
      assert.equal(structureIndex.artifactVersion, 10);
      assert.equal(structureIndex.contractVersion, 8);
      ...
      assert.equal(semanticClusterIndex.artifactVersion, 10);
      assert.equal(semanticClusterIndex.contractVersion, 8);
      ...
      assert.equal(hubSuggestionIndex.artifactVersion, 10);
      assert.equal(hubSuggestionIndex.contractVersion, 8);
      ...
      assert.equal(fullManifest.artifactVersion, 10);
      assert.equal(fullManifest.contractVersion, 8);
