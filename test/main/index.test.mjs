...
describe("index", () => {
  it("creates the populated .contextplus project layout and snapshots", async () => {
    ...
    try {
      ...
      assert.equal(config.artifactVersion, 15);
      ...
      assert.equal(indexStatus.artifactVersion, 15);
      ...
      assert.equal(chunkIndex.artifactVersion, 15);
      ...
      assert.equal(hybridChunkIndex.artifactVersion, 15);
      ...
      assert.equal(hybridIdentifierIndex.artifactVersion, 15);
      ...
      assert.equal(structureIndex.artifactVersion, 15);
      ...
      assert.equal(semanticClusterIndex.artifactVersion, 15);
      ...
      assert.equal(hubSuggestionIndex.artifactVersion, 15);
      ...
      assert.equal(fullManifest.artifactVersion, 15);
