...
describe("index", () => {
  it("creates the .contextplus project layout and snapshots", async () => {
    ...
    try {
      ...
      assert.equal(config.artifactVersion, 6);
      assert.equal(config.indexMode, "full");
      assert.equal(config.contract.contractVersion, 4);
      ...
      assert.equal(indexStatus.contractVersion, 4);
      assert.equal(indexStatus.artifactVersion, 6);
      ...
      assert.equal(stageState.contractVersion, 4);
      ...
      assert.equal(chunkIndex.artifactVersion, 6);
      assert.equal(chunkIndex.contractVersion, 4);
      ...
      assert.equal(hybridChunkIndex.artifactVersion, 6);
      assert.equal(hybridChunkIndex.contractVersion, 4);
      ...
      assert.equal(hybridIdentifierIndex.artifactVersion, 6);
      assert.equal(hybridIdentifierIndex.contractVersion, 4);
      ...
      assert.equal(fullManifest.artifactVersion, 6);
      assert.equal(fullManifest.contractVersion, 4);
