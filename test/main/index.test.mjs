...
describe("index", () => {
  it("creates the populated .contextplus project layout and snapshots", async () => {
    ...
    try {
      ...
      assert.equal(config.version, 16);
      assert.equal(config.artifactVersion, 16);
      ...
      assert.equal(indexStatus.artifactVersion, 16);
      ...
      assert.equal(chunkIndex.artifactVersion, 16);
      ...
      assert.equal(hybridChunkIndex.artifactVersion, 16);
      ...
      assert.equal(hybridIdentifierIndex.artifactVersion, 16);
      ...
      assert.equal(structureIndex.artifactVersion, 16);
      ...
      assert.equal(semanticClusterIndex.artifactVersion, 16);
      ...
      assert.equal(hubSuggestionIndex.artifactVersion, 16);
      ...
      assert.equal(queryExplanationIndex.artifactVersion, 16);
      ...
      assert.equal(fullManifest.artifactVersion, 16);
