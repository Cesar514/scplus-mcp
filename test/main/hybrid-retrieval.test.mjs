...
describe("hybrid-retrieval", () => {
  it("persists hybrid chunk and identifier indexes in sqlite", async () => {
    ...
    try {
      ...
      assert.equal(hybridChunk.state.artifactVersion, 6);
      assert.equal(hybridChunk.state.contractVersion, 4);
      ...
      assert.equal(hybridIdentifier.state.artifactVersion, 6);
      assert.equal(hybridIdentifier.state.contractVersion, 4);
