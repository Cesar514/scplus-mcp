...
describe("hybrid-retrieval", () => {
  it("persists hybrid chunk and identifier indexes in sqlite", async () => {
    ...
    try {
      ...
      assert.equal(hybridChunk.state.artifactVersion, 7);
      assert.equal(hybridChunk.state.contractVersion, 5);
      ...
      assert.equal(hybridIdentifier.state.artifactVersion, 7);
      assert.equal(hybridIdentifier.state.contractVersion, 5);
