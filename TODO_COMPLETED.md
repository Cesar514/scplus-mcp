...
[x] 2026-05-05T15:42:17Z Replace full recursive backend polling with a bounded scanner module persisted in sqlite. \
[x] 2026-05-05T15:42:17Z Remove default recursive native watcher behavior from embedding tracking and generated configs. \
[x] 2026-05-05T15:42:17Z Remove unused Go fsnotify watcher code and dependency. \
[x] 2026-05-05T15:42:17Z Add scanner diagnostics, watch overflow caps, and bounded event payloads. \
[x] 2026-05-05T15:42:17Z Add targeted tests for scanner budgets, no native watch defaults, watch batching, and large-repo coverage. \
[x] 2026-05-05T15:42:17Z Run build, Go tests, targeted Node tests, and completion audit against `implementation.md`. \
[x] 2026-05-05T15:16:03Z Create `implementation.md` with a complete migration checklist for bounded watcher/scanner behavior. \
[x] 2026-04-13T18:16:00Z Rewrite the script file-header lint contract in `src/tools/static-analysis-core.ts` so file headers require `summary`, `purpose`, `inputs`, and `returns/effects`, and drop the old `FEATURE` and `outputs` requirements. \
[x] 2026-04-13T18:16:00Z Update `src/tools/propose-commit.ts` to enforce the same four-line structured script header contract during checkpoint validation. \
[x] 2026-04-13T18:16:00Z Update the header-focused static-analysis and propose-commit tests to assert `purpose-header`, `inputs-header`, and `returns/effects-header` under the new contract. \
[x] 2026-04-13T18:16:00Z Rebuild and verify the rewritten header rule with targeted static-analysis coverage plus direct demonstrations of the new missing-field warnings. \
[x] 2026-04-13T17:06:35Z Add the missing two-line file headers to the remaining `header` lint offenders in `landing/*.mjs`, `test/demo/*.mjs`, and the affected `test/main/*.mjs` files. \
[x] 2026-04-13T17:06:35Z Rerun the repo-wide `header` rule check and verify that the remaining `header` lint error count is now zero. \
