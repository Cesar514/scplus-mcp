...
| Tool                         | When to Use                                                                        |
| ---------------------------- | ---------------------------------------------------------------------------------- |
| `index`                      | Build or refresh repo-local `.contextplus/` state. Full mode is the default and persists file, identifier, chunk, and code-structure indexes plus indexing status and versioned contract metadata. |
