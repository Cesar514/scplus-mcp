...
const toolRefRows = [
  ...
  {
    name: "search",
    desc: "Search files or identifiers by meaning. Use search_type 'file' for semantic file retrieval or 'identifier' for symbol matches with ranked call sites.",
    input: "{ search_type: 'file' | 'identifier', query: string, top_k?: number }",
    output:
  ...
  {
    name: "restore_points",
    desc: "List all shadow restore points created by checkpoint. Each captures file state before AI changes.",
    input: "{ }",
    output:
